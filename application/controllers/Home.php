...
class Home extends CI_Controller {
    ...
    public function registerProcess()
    {
        ...
        $this->form_validation->set_rules('email','Email','required|trim|valid_email',array('required' => 'Email tidak boleh kosong', 'valid_email' => 'Email Salah'));
        ...
        if($this->form_validation->run() != false){
            ...
            $this->session->set_flashdata("success_insert_user", "Pendaftaran Berhasil");
    ...
    public function loginAction()
    {
        ...
        if($this->form_validation->run() != false){
            ...
            if($cekQuery){
                ...
                echo "Data User Tidak ada, Silakan Daftar Terlebih dahulu";
                return 0;
            }
    ...
    {
        $this->form_validation->set_rules('title','Title','required',array('required' => 'Silahkan isi Judul'));
        $this->form_validation->set_rules('article','Article','required',array('required' => 'Silahkan Masukkan Artikel'));
        ...
        if($this->form_validation->run() != false){
            ...
            if (!$this->upload->do_upload('cover_img')) {
                ...
                return 0;
                $this->session->set_flashdata('error_upload_Images' ,'Foto gagal diupload');
            } else {
